...
class FOV_grid_coverage_sensor_frame:
    ...
    def compute_fov_coverage(self, cart_grid_properties):
        ...
        return identify_coordinates_that_are_within_sensor_fov(x_coord, y_coord, lib_const.radar_fov_ranges, lib_const.radar_fov_azimuths)
...
class FOV_grid_coverage:
    ...
    def compute_fov_coverage(self, cart_grid_properties):
        ...
        for sensor in range(lib_const.num_radars):
            ...
            self.fov_coverage_flag[sensor, :] = identify_coordinates_that_are_within_sensor_fov(x, y, lib_const.radar_fov_ranges, lib_const.radar_fov_azimuths)
