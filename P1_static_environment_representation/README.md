...
In this section we show brief animations of the results.
   ...
   [Longer Sequence Animation Link](https://github.com/UditBhaskar19/ENVIRONMENT_REPRESENTATION_USING_RADAR/blob/main/P1_static_environment_representation/readme_artifacts/radar_dense_point_cloud_long_seq.gif)
   ...
   [Longer Sequence Animation Link](https://github.com/UditBhaskar19/ENVIRONMENT_REPRESENTATION_USING_RADAR/blob/main/P1_static_environment_representation/readme_artifacts/free_space_computation_radar_long_seq.gif)
   ...
   [Longer Sequence Animation Link](https://github.com/UditBhaskar19/ENVIRONMENT_REPRESENTATION_USING_RADAR/blob/main/P1_static_environment_representation/readme_artifacts/road_boundary_long_seq.gif)
