...
class animate(object):
    ...
    def __init__(self, ax):
        ...
        self.radar_fov = ax.scatter([],[], s=5, color='blue', marker='.', alpha=0.05, label='active radar fov')
    ...
    def __call__(self, t):
        ...
        self.radar_fov.set_offsets(self.xy_grid_coord[self.fov_coverage_flag[radar_id]])
